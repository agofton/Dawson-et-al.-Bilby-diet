#!/bin/bash
#
#	Requirements: usearch9.2, usearch10 and usearch8 must be installed on the PATH as "usearch9.2" and"usearch8" - it does not matter whether
...
fwd_primer="AGAGTTTGATCCTGGCTYAG"    # <- enter corrent primers for your analysis here
# Enter REV primer sequence 5'-3' (degenerate bases OK)
rev_primer="TGCTGCCTCCCGTAGGAGT"    # <- enter corrent primers for your analysis here
...
for file1 in ${raw_data}/*R1_001.fastq; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for file3 in ${merged_data}/*.fastq; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	echo Quality control and removing dimer seqs
	echo input is:
...
for file5 in seqs_w_fwd_primer/*.fasta; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for file6 in seqs_w_fwd_and_rev_primer/*.fasta; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for file7 in ${trimmed_data}/*.fasta; do
...
for file9 in ${labeled_data}/*.fasta; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
for file11 in ${labeled_data}/*.fasta; do
	echo ""
	echo ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
